...
namespace WinFormsApp1.Events
{
    public class GameEventManager : IGameEventPublisher
    {
            ...
            int healthGain, int attackGain, int defenseGain, int skillPointsGained)
        {
            ...
            PublishMessage($"{GameConstants.LEVEL_UP_MSG} {newLevel}! (+{healthGain} HP, +{attackGain} ATK, +{defenseGain} DEF, +{skillPointsGained} SP)", 
        ...
        public void PublishCombatStart(Player player, Enemy enemy)
        {
            ...
            PublishMessage($"{GameConstants.COMBAT_BEGIN_MSG} A {enemy.Name} appears!", Color.Red, MessageType.Combat);
        ...
        public void PublishCombatEnd(Player player, Enemy enemy, bool playerWon, int experienceGained = 0, int goldGained = 0, List<Item>? lootGained = null)
        {
            ...
            if (playerWon)
            {
                PublishMessage($"{GameConstants.COMBAT_VICTORY_MSG} {enemy.Name}!", Color.Green, MessageType.Combat);
            ...
            {
                PublishMessage(GameConstants.COMBAT_DEFEAT_MSG, Color.Red, MessageType.Combat);
            }
        }
    ...
    // Event Handler Interfaces for type safety
    public interface IPlayerEventHandler
    {
        ...
        void OnPlayerGoldChanged(object? sender, GoldChangeEventArgs e);
        void OnPlayerHealthChanged(object? sender, HealthChangeEventArgs e);
        void OnPlayerLearnedSkill(object? sender, SkillEventArgs e);
    }
    ...
    {
        void OnPlayerMovedLocation(object? sender, LocationChangeEventArgs e);
        void OnInventoryChanged(object? sender, InventoryChangeEventArgs e);
        void OnItemUsed(object? sender, ItemUsedEventArgs e);
    }

    public interface IGameStateEventHandler
    {
        void OnGameStateChanged(object? sender, GameStateEventArgs e);
        void OnGameSaved(object? sender, SaveGameEventArgs e);
        void OnGameLoaded(object? sender, LoadGameEventArgs e);
        void OnCommandExecuted(object? sender, CommandEventArgs e);
        void OnCheatActivated(object? sender, CheatEventArgs e);
    }

    public interface IMessageEventHandler
    {
        void OnMessageDisplayed(object? sender, MessageEventArgs e);
    }
} 