...
namespace WinFormsApp1
{
    public class GameEngine
    {
        ...
        private void AddGold(string[] args)
        {
            ...
            player.Gold += amount;
            eventManager.PublishGoldChange(player, amount, "cheat command");
            eventManager.PublishCheatActivated("addgold", args, player);
            UpdateCharacterDisplay();
        }
        ...
        private void AddExperience(string[] args)
        {
            ...
            eventManager.PublishExperienceGain(player, amount, leveledUp);
            eventManager.PublishCheatActivated("addexp", args, player);
            UpdateCharacterDisplay();
        }
        ...
        private void CheatLevelUp(string[] args)
        {
            ...
            eventManager.PublishPlayerLevelUp(player, oldLevel, player.Level, 10, 2, 1, 5);
            eventManager.PublishHealthChange(player, 10, "level up full heal");
            eventManager.PublishCheatActivated("levelup", args, player);
            UpdateCharacterDisplay();
        }
        ...
        private void SetLevel(string[] args)
        {
            ...
            eventManager.PublishCheatActivated("setlevel", args, player);
            UpdateCharacterDisplay();
        }
        ...
        private void FullHeal()
        {
            ...
            player.Health = player.MaxHealth;
            eventManager.PublishHealthChange(player, healAmount, "cheat heal");
            eventManager.PublishCheatActivated("heal", new string[0], player);
            UpdateCharacterDisplay();
        }
        ...
        private void GiveItem(string[] args)
        {
            ...
            if (item != null)
            {
                ...
                eventManager.PublishCheatActivated("additem", args, player);
            }
            else
            {
        ...
        private void ClearInventory()
        {
            ...
            eventManager.PublishInventoryChange(player, null, false, itemCount, currentLocation);
        }
        ...
        private void TeleportToLocation(string[] args)
        {
            ...
            if (locations.ContainsKey(locationKey))
            {
                ...
                eventManager.PublishLocationChange(player, oldLocation, currentLocation, "teleport");
                eventManager.PublishCheatActivated("teleport", args, player);
                ShowLocation();
                UpdateCharacterDisplay();
            }
            else
        ...
        private void KillAllEnemies()
        {
            ...
            eventManager.PublishMessage($"Removed {enemyCount} enemies from {currentLocation.Name}.", Color.Orange, MessageType.System);
        }
        ...
        private void ResetGameState()
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                eventManager.PublishGameStateChange("GameReset", player);
                ShowLocation();
                UpdateCharacterDisplay();
            }
        }
        ...
        private void ShowLocation()
        {
            ...
            eventManager.PublishMessage(currentLocation.Description, MessageType.System);
            eventManager.PublishMessage("", MessageType.Normal);
            ...
            if (currentLocation.Items.Any())
            {
                ...
                {
                    eventManager.PublishMessage($"  - {item.Name}", MessageType.System);
                }
                eventManager.PublishMessage("", MessageType.Normal);
            }
            ...
            if (currentLocation.Enemies.Any())
            {
                ...
                {
                    eventManager.PublishMessage($"  - {enemy.Name} (Level {enemy.Level})", MessageType.System);
                }
                eventManager.PublishMessage("", MessageType.Normal);
            }
            ...
            if (currentLocation.Exits.Any())
            {
                ...
                {
                    eventManager.PublishMessage($"  {exit.Key} - {exit.Value}", MessageType.System);
                }
            }
        }
        ...
        public void ShowInventory()
        {
            ...
            if (player.Inventory.Any())
            {
                ...
                {
                    eventManager.PublishMessage($"  - {item.Name}: {item.Description}", MessageType.System);
                }
            }
            else
            {
                eventManager.PublishMessage(GameConstants.INVENTORY_EMPTY_MSG, MessageType.System);
            }
            eventManager.PublishMessage("", MessageType.Normal);
        }
        ...
        public void ShowCharacterStats()
        {
            ...
            eventManager.PublishMessage($"Name: {player.Name}", MessageType.System);
            eventManager.PublishMessage($"Class: {player.CharacterClass}", MessageType.System);
            eventManager.PublishMessage($"Level: {player.Level}", MessageType.System);
            eventManager.PublishMessage($"Experience: {player.Experience}/{player.ExperienceToNextLevel}", MessageType.System);
            eventManager.PublishMessage($"Health: {player.Health}/{player.MaxHealth}", MessageType.System);
            eventManager.PublishMessage($"Attack: {player.Attack}", MessageType.System);
            eventManager.PublishMessage($"Defense: {player.Defense}", MessageType.System);
            eventManager.PublishMessage($"Gold: {player.Gold}", MessageType.System);
            eventManager.PublishMessage("", MessageType.Normal);
        }
        ...
        public void ShowHelp()
        {
            ...
            eventManager.PublishMessage("Movement: go [direction], north, south, east, west", MessageType.System);
            eventManager.PublishMessage("Interaction: look, take [item], use [item]", MessageType.System);
            eventManager.PublishMessage("Character: inventory (inv), stats, skills, help", MessageType.System);
            eventManager.PublishMessage("Combat: attack [enemy], defend, flee", MessageType.System);
            eventManager.PublishMessage("Game: save [name], load [name], saves/list, quit", MessageType.System);
            eventManager.PublishMessage("Special: cheat/cheats - Show cheat code information", MessageType.System);
            eventManager.PublishMessage("", MessageType.Normal);
            eventManager.PublishMessage("Save Commands:", MessageType.System);
            eventManager.PublishMessage("  save - Quick save with timestamp", MessageType.System);
            eventManager.PublishMessage("  save [name] - Save with custom name", MessageType.System);
            eventManager.PublishMessage("  load - Load quick save", MessageType.System);
            eventManager.PublishMessage("  load [name] - Load specific save", MessageType.System);
            eventManager.PublishMessage("  saves/list - Show all available saves", MessageType.System);
            eventManager.PublishMessage("", MessageType.Normal);
            eventManager.PublishMessage("Character Development:", MessageType.System);
            eventManager.PublishMessage("  skills - Open skill tree to learn new abilities", MessageType.System);
            eventManager.PublishMessage("", MessageType.Normal);
            eventManager.PublishMessage(GameConstants.CHEAT_ACTIVATION_MSG, Color.Yellow, MessageType.Cheat);
            eventManager.PublishMessage("To activate cheats, try these classic commands:", MessageType.Cheat);
            eventManager.PublishMessage($"  • {GameConstants.CHEAT_IDDQD} (Doom god mode)", MessageType.Cheat);
            eventManager.PublishMessage($"  • {GameConstants.CHEAT_IDKFA} (Doom all weapons)", MessageType.Cheat);
            eventManager.PublishMessage($"  • {GameConstants.CHEAT_THEREISNOSPOON} (Matrix reference)", MessageType.Cheat);
            eventManager.PublishMessage($"  • Konami Code: {GameConstants.CHEAT_UP} {GameConstants.CHEAT_UP} {GameConstants.CHEAT_DOWN} {GameConstants.CHEAT_DOWN} {GameConstants.CHEAT_LEFT} {GameConstants.CHEAT_RIGHT} {GameConstants.CHEAT_LEFT} {GameConstants.CHEAT_RIGHT} {GameConstants.CHEAT_B} {GameConstants.CHEAT_A}", MessageType.Cheat);
            eventManager.PublishMessage("Once activated, type 'cheathelp' for cheat commands!", MessageType.Cheat);
            eventManager.PublishMessage("", MessageType.Normal);
        }
            ...
            try
            {
                ...
                if (saveFiles.Any())
                {
                    ...
                    foreach (var saveFile in saveFiles)
                    {
                        ...
                        eventManager.PublishMessage($"• {saveFile}", MessageType.System);
                        eventManager.PublishMessage($"  Modified: {lastModified:yyyy-MM-dd HH:mm:ss}", MessageType.System);
                        eventManager.PublishMessage($"  Size: {fileSize:N0} bytes", MessageType.System);
                        eventManager.PublishMessage("", MessageType.Normal);
                    }
        ...
        public void DisplayMessage(string message, Color? color = null)
        {
            ...
            eventManager.PublishMessage(message, color);
        }
